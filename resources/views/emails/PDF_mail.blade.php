...
<body>
    ...
    <div style="display:flex; gap:1rem">
        <a id="accept" href="{{route('user.grade', ['question'=> $assignment->id, 'key'=> (string) $assignment->grade_key, 'accept'=>true])}}"><button
                ...
                aanmelding</button></a>
        <a id="reject" href="{{route('user.grade', ['question'=> $assignment->id, 'key'=> (string) $assignment->grade_key, 'accept'=>false])}}"><button
